...
export const en: Record<TranslationKey, string> = {
  ...
  'event.allDayPrefix': '(All day) ',
  'event.creator': 'Creator: {name}',
  'event.copyToPersonal': 'Copy to personal',
  'event.editSharedEvent': 'Edit shared event',
  'event.sharedCalendar': 'Shared Calendar',
  'event.viewOnly': '(view only)',
  'event.readOnly': '(read only)',
  'event.externalCalendar': 'External Calendar',
  'event.deleteConfirm': 'Delete "{title}"?',
  'event.deleteTitle': 'Delete "{title}"',
  'event.deleteMultiCalendarMsg': 'This event exists in multiple calendars. Select which calendars to delete from.',
  'event.selectAll': 'Select all',
  'event.createAtTime': 'Create event at {time}:00',
